  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-side is-drawer-close:overflow-visible">
        <div className="flex min-h-full flex-col items-center  is-drawer-close:w-16 is-drawer-open:w-64">
          <ul className="menu w-full grow dash-side-bar">
            <li>
              <button
            ...
            <li>
              ...
              >
                ...
                <span className="is-drawer-close:hidden">Clubs members</span>
              </button>
            </li>
            ...
            <li>
              ...
              >
                ...
                <NavLink to="/dashboard/myEvent">
                  <MdOutlineEventAvailable size={24}></MdOutlineEventAvailable>
